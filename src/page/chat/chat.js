...
function webSocketSession() {
	...
	var name
	// websocket = new WebSocket("wss://blogs.wcytk.com/blogSystem/echo")
	websocket = new WebSocket("wss://blogs.wcytk.com/blogSystem/echo")
	websocket.onopen = function (evnt) {
		$.ajax({
			type: "POST",
			url: _cmds.getServerUrl('/blogSystem/getUser.do'),
			dataType: "json",
	...
	websocket.onmessage = function (evnt) {
		...
		var message = "<li class='meida alert " + style + " ' role='alert'><div class='media-left'><img src='../resource/" + image + "' width='30px'" +
